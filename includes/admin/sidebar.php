<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        ...
        <div class="sidebar-brand"><strong>SAHARA</strong><span>IIT M BS Welfare</span>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="dashboard.php" class="sidebar-link <?php echo $current_page == "dashboard.php" ? "active" : ""; ?>">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM14 5a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 16a1 1 0 011-1h4a1 1 0 011 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-3zM14 13a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1h-4a1 1 0 01-1-1v-5z"/>
            </svg>
        ...
        <a href="donation-requests.php" class="sidebar-link <?php echo $current_page == "donation-requests.php" ? "active" : ""; ?>">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="sidebar-footer">
        ...
        <div>
            <div class="sidebar-user-name"><?php echo $user_name; ?></div>
            <div class="sidebar-user-role">Administrator</div>
        </div><button class="sidebar-logout" title="Logout" onclick="window.location.href='../actions/auth/logout.php'">
            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
